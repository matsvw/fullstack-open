...
const getRepositoryPayload = (
  ...
  return {
    ...
    forksCount: lodash.get(githubRepository, 'forks_count') || 0,
    stargazersCount: lodash.get(githubRepository, 'stargazers_count') || 0,
    description: lodash.get(githubRepository, 'description') || null,
    language: lodash.get(githubRepository, 'language') || null,
    ownerAvatarUrl: lodash.get(githubRepository, 'owner.avatar_url') || null,
  };
};
